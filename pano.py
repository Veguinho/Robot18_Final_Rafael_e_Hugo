...
class Stitch:
	def __init__(self, args):
		...
		print filenames
		self.images = [cv2.resize(cv2.imread(each),(480*3, 320*3)) for each in filenames]
	...
	def prepare_lists(self):
		print "Numero de imagens : %d"%self.count
		self.centerIdx = self.count/2 
		#print "Center index da imagem : %d"%self.centerIdx
